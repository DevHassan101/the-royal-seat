    ...
    <tr class="border-b border-gray-200 hover:bg-gray-50 transition-colors duration-200">
        <td class="px-6 py-4 text-sm">
            <div class="flex items-center gap-3">
                <img class="w-10 h-10 rounded-full" src="{{ asset($vehicle->picture) }}" alt="" srcset="">
                <div>
                    <p class="text-gray-900 font-medium whitespace-nowrap">{{ $vehicle->name }}</p>
                    <p class="text-gray-500 whitespace-nowrap">{{ $vehicle->plate_number }}</p>
                </div>
            </div>
        </td>
        <td class="px-6 py-4 text-sm">
        ...
        <td class="px-6 py-4 text-sm">
            <div class="flex items-center justify-center gap-2">
                ...
                <form action="{{ route('itc.sync-vehicle', $vehicle) }}" method="POST" class="inline-block">
                    ...
                    <button type="submit"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" class="transition-all duration-300">
                            <path
                ...
                <a href="{{ route('vehicle.edit', ['vehicle' => $vehicle]) }}"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                        class="transition-all duration-300">
                        <g fill="none" stroke-linecap="round" stroke="currentColor" stroke-linejoin="round"
                            stroke-width="2">
                            <path
                ...
                <form action="{{ route('vehicle.destroy', ['vehicle' => $vehicle]) }}" method="post"
                    onsubmit="return confirm('Are you sure you want to delete this vehicle?');" class="inline-block">
                    @csrf
                    @method('DELETE')
                    <button type="submit"
            ...
            <td colspan="7" class="px-6 py-12 text-center">
                <div class="flex flex-col items-center justify-center text-gray-400">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 48 48"
                        ...
                        <rect class="b" x="4.5" y="21.66" width="39" height="14.4857" rx="4.4571"
                            ry="4.4571" />
                        <path class="b"
