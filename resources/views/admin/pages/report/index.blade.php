    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden mb-8">
        ...
        <form action="{{ route('report.generate') }}" method="POST" class="p-6" id="reportForm">
            ...
            <div class="flex items-center gap-3">
                <button type="submit"
                    class="flex items-center px-6 py-3 font-semibold bg-white !border !border-[#c9982b] !text-[#c9982b] hover:!bg-[#c9982b] hover:!text-white rounded-xl hover:shadow-lg transform hover:scale-105 transition-all duration-200">
