...
<div
    ...
    class="fixed z-20 inset-0 bg-black/50 lg:hidden"
    style="display: none;">
</div>
...
<div :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
    ...
    <nav class="mt-5 px-5" x-data="{ isMultiLevelMenuOpen: false }">
            ...
            <div class="flex justify-between items-center -ml-6.5 w-full">
                <span class="p-2.5 rounded-lg transition-all duration-300
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 24 24" 
                        class="transition-all duration-300 {{ request()->routeIs('driver.dashboard') ? 'scale-110' : 'group-hover:scale-110' }}">
                        <path fill="{{ request()->routeIs('driver.dashboard') ? '#c9982b' : '#c9982b' }}"
        ...
        {{-- Vehicles Link --}}
        <x-nav-link href="{{ route('driver.vehicle.index') }}" :active="request()->routeIs('driver.vehicle.*')"
            class="flex items-center px-4 py-2 mb-2 rounded-lg transition-all duration-300 group
            {{ request()->routeIs('driver.vehicle.*')
                ? 'bg-[#c9982b]/20 border-l-4 border-[#c9982b]'
                : 'hover:bg-black hover:border-l-4 hover:border-[#c9982b]/40' }}">
            <div class="flex justify-between items-center -ml-6.5 w-full">
                <span class="p-2.5 rounded-lg transition-all duration-300
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                        class="transition-all duration-300 {{ request()->routeIs('driver.vehicle.*') ? 'scale-110' : 'group-hover:scale-110' }}">
        ...
        {{-- Bookings Link --}}
        <x-nav-link href="{{ route('driver.booking.index') }}" :active="request()->routeIs('driver.booking.*')"
            class="flex items-center px-4 py-2 mb-2 rounded-lg transition-all duration-300 group
            {{ request()->routeIs('driver.booking.*')
                ? 'bg-[#c9982b]/20 border-l-4 border-[#c9982b]'
                : 'hover:bg-black hover:border-l-4 hover:border-[#c9982b]/40' }}">
            <div class="flex justify-between items-center -ml-6.5 w-full">
                <span class="p-2.5 rounded-lg transition-all duration-300
                    {{ request()->routeIs('driver.booking.*')
                        ...
                        : 'bg-black/10 group-hover:bg-[#c9982b]/20' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"
                        class="transition-all duration-300 {{ request()->routeIs('driver.booking.*') ? 'scale-110' : 'group-hover:scale-110' }}">
                        <path fill="#c9982b"
        ...
        {{-- Expenses Link --}}
        <x-nav-link href="{{ route('driver.expense.index') }}" :active="request()->routeIs('driver.expense.*')"
            class="flex items-center px-4 py-2 mb-2 rounded-lg transition-all duration-300 group
            {{ request()->routeIs('driver.expense.*')
                ? 'bg-[#c9982b]/20 border-l-4 border-[#c9982b]'
                : 'hover:bg-black hover:border-l-4 hover:border-[#c9982b]/40' }}">
            <div class="flex justify-between items-center -ml-6.5 w-full">
                <span class="p-2.5 rounded-lg transition-all duration-300
                    {{ request()->routeIs('driver.expense.*')
                        ? 'bg-[#c9982b]/30'
                        : 'bg-black/10 group-hover:bg-[#c9982b]/20' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" version="1.2" viewBox="0 0 1000 870" width="22"  class="transition-all duration-300 {{ request()->routeIs('driver.expense.*') ? 'scale-110' : 'group-hover:scale-110' }}"
                        height="22">
